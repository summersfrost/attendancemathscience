...
public class subject extends javax.swing.JPanel {
    ...
    public void displayTable() {
      ...
      try {
        ...
        table.getColumn("Delete").setCellRenderer(new subject.ButtonRenderer());
        table.getColumn("Delete").setCellEditor(new subject.ButtonEditor(new JCheckBox()));
    ...
    class ButtonRenderer extends JButton implements TableCellRenderer {
      ...
      public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (column == 4) {
          ...
          setBackground(Color.RED); // Set the background color to green for "Update" button
        } 
